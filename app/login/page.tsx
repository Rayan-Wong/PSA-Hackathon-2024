  ...
  return (
    <section className="bg-gray-50 dark:bg-gray-900">
        <div className="flex flex-col md:flex-row items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
            <div className='hidden md:block ml-14 mr-10 space-y-4 pb-10 md:m-0 md:pb-0 sm:max-w-md'>
                <a href="#" className="flex space-y-1 md:space-x-3 md:space-y-0 flex-col md:flex-row items-center mb-6 text-2xl font-semibold text-gray-900 dark:text-white">
                    ...
                    {/* <img className="w-8 h-8 mr-2" src="@/public/logo.svg"/> */}
                    <p>Our name</p>  
                </a>
                <h1 className='dark:text-white text-5xl lg:text-7xl'>Need help?</h1>
                <h1 className='dark:text-white text-3xl lg:text-5xl'>Your best friend is one click away.</h1>
            </div>
